   ...
   return {
     books: [
       ...
       { 
         ...
         description: '"O Código Da Vinci" é um thriller que mistura mistério, história e símbolos ocultos. A história segue o professor de simbologia Robert Langdon, que é chamado para investigar o assassinato de um curador do Museu do Louvre, em Paris. Ao lado de Sophie Neveu, neta da vítima, Langdon descobre uma série de pistas ocultas nas obras de arte e documentos históricos, que levam a um segredo milenar envolvendo o Santo Graal. O livro questiona aspectos da história cristã e explora temas de fé, conspiração e a busca por verdades ocultas.' 
       }
     ],
     book: null, 
     userRating: 0,
